...
public class ContentCodeGenerator {
	...
	//数据库账号
	private static final String DATA_SOURCE_USER_NAME  = "onlineeducation";
	//数据库密码
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://www.996so.icu:3307/xc166_" + SERVICE_NAME
